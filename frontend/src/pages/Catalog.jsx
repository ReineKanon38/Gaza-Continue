...
function Catalog() {
    ...
    const normalizeSyscomProduct = (product) => {
        ...
        return {
            ...
            brand: product.brand || product.marca || product.distributor || '',
            distributor: product.brand || product.marca || product.distributor || product.fabricante || product.proveedor || '',
            marca: product.brand || product.marca || product.distributor || '',
            modelo: product.model || product.modelo || syscomId,
